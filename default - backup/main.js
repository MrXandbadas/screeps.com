...
module.exports.loop = function () {
    ...
    for (let name in Game.creeps) {
        ...
        Game.spawns.SpawnAlpha.memory.debugspawn = 1;
    ...
    var towers = Game.rooms.E2N47.find(FIND_STRUCTURES, {
        ...
        // Begin Spawning
            ...
            if (spawn.memory.repopulate == 'true') {
                ...
                if (numberOfHarvesters < spawn.memory.minHarvesters) {
                    ...
                    name = spawn.createCustomCreep(this)
                }
                ...
                //if not then do the save resources thingy
                else if (name = "Undefined") {
                console.log('got to full?');
                }
